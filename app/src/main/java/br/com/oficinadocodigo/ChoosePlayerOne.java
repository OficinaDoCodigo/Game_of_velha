...
public class ChoosePlayerOne extends ActionBarActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_player_one);
        ...
        switch (v.getId()) {
            case R.id.btn_novo_escolherPlayer:
                if (btn_novo.getText().toString().equals("PRÓXIMO")) {
                    trocarTela(ChoosePlayerTwo.class);
                }
                else{
